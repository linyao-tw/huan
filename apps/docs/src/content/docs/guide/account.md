---
title: "登入"
description: "HUAN 沒有公開註冊。帳號一律由最高權限管理員在後台建立，第一個管理員則由 CLI 建立。"
---
...
Session 預設 14 天過期。可以在[安全設定](/guide/two-factor#工作階段)看到所有登入中的裝置並個別撤銷。
...
請最高權限管理員到[使用者管理](/guide/users)重設。所有管理員都無法登入時，用 CLI 再建立一個。
